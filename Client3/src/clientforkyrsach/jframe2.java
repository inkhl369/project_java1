...
ArrayList<cars> list = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        year.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025" }));
        ...
        button.setText("Подсчитать стоимость товаров");
        ...
        diagramma.setText("Диаграмма товаров в корзине");
    ...
    public static boolean isString(String x) throws NumberFormatException
{
    ...
    private void thirdframeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_thirdframeMouseClicked

            klienttable.clearSelection();
             DeleteButton.setEnabled(false);
        
    }//GEN-LAST:event_thirdframeMouseClicked
    ...
    private void klienttableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_klienttableMouseClicked
    ...
    }//GEN-LAST:event_klienttableMouseClicked
    ...
    private void poiskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_poiskActionPerformed
     tablica2();
    }//GEN-LAST:event_poiskActionPerformed

    private void diagrammaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_diagrammaActionPerformed
...
diagrammframe.getContentPane().repaint();
    ...
    private void seeallinfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seeallinfoActionPerformed
       Point point;
            point= getLocation();
    ...
    }//GEN-LAST:event_seeallinfoActionPerformed
    ...
    private void thirdframeWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_thirdframeWindowClosing
        DeleteButton.setEnabled(false);
